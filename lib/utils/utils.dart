...
class AppConfig {
  static const appName = "Sistem Informasi Kemajuan Akademik";
  static const appTagline = "Pascasarjana Universitas Pendidikan Ganesha";
}
...
class AvailableImages {
  ...
  static const appLogo = const AssetImage('assets/images/LogoUndiksha.png');
  static const errorimg = const AssetImage('assets/images/error.png');
  static const notfoundimg = const AssetImage('assets/images/notfound.png');
  static const notfoundgif = const AssetImage('assets/images/notfound.gif');
  static const nodata = const AssetImage('assets/images/notfound.png');
}
